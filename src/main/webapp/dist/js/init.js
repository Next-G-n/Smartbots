...
var zapily = function(){
	...
	/*Sidebar Navigation*/
	$(document).on('click', '#toggle_nav_btn,#open_right_sidebar ,#open_profile,#open_track,#setting_panel_btn', function (e) {
	...
	$(document).on('click', '#open_right_sidebar ,#open_profile, #open_track', function (e) {
