...
public class Request {
    ...
    public Request(int request_Id, int company_Id, int number_Of_Positions_Required, String qualification_Requirements, String duty_Station, String department_Division, String brief_Description, String date_Unix, String status) {
